...
class OverviewReportItemGetSerializer(serializers.Serializer):
    ...
    sort_by = serializers.CharField(max_length=100, required=False, default='item_id__name')
    ...
    def create(self, validated_data) -> OverviewReportItemGet:
        return OverviewReportItemGet(**validated_data)
    ...
    def get_parameters():
        return [
            ...
            OpenApiParameter(
                ...
                location=OpenApiParameter.QUERY,
                type=str,
                enum=['item_name', 'category', 'brand', 'supplier']
            ),
            OpenApiParameter(
                name='filter_value',
