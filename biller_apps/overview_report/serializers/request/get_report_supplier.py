...
class OverviewReportSupplierGetSerializer(serializers.Serializer):
    ...
    def create(self, validated_data) -> OverviewReportSupplierGet:
        return OverviewReportSupplierGet(**validated_data)
    ...
    def get_parameters():
        return [
            ...
            OpenApiParameter(
                name='filter_key',
                description='Field to filter by (e.g., "supplier_name")',
                required=False,
                location=OpenApiParameter.QUERY,
                type=str,
                enum=['supplier_name', 'supplier_code', 'mobile_number']
            ),
            OpenApiParameter(
                name='filter_value',
