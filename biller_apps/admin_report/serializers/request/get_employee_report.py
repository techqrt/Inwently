...
class AdminReportEmployeeGetSerializer(serializers.Serializer):
    ...
    def create(self, validated_data) -> AdminReportEmployeeGet:
        return AdminReportEmployeeGet(**validated_data)
    ...
    def get_parameters():
        return [
            ...
            OpenApiParameter(
                name='filter_key',
                description='Field to filter by (e.g., "employee_name")',
                required=False,
                location=OpenApiParameter.QUERY,
                type=str,
                enum=['employee_name', 'employee_code', 'email', 'dob', 'created_date']
            ),
            OpenApiParameter(
                name='filter_value',
