...
from biller_apps.admin_report.dataclasses.request.search_pattern import AdminReportSearchPattern
from biller_apps.common.elastich_query import ElasticQuery


class AdminReportEsQuery:
    @staticmethod
    def search_pattern_start_with_query(organisation_id: int, request_keys: str, limit: int, page_num: int,
        ...
        for hit in response:
            search_res = AdminReportSearchPattern(name=hit.name, brandCode=hit.brand_code)
